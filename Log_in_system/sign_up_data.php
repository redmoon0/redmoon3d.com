          ...
          <div class="container-fluid px-lg-5 px-sm-0 d-flex justify-content-between align-items-center">          
            ...
            <div class="d-flex align-items-center">
              <?php if(isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true): ?>
                <a class="btn btn-red-outline py-2 d-none d-lg-block me-5" style="width: 120px !important;" href="Log_in_system/log_in.php">Dashboard</a>
                <i class="bi bi-person-circle fs-3 text-light d-block d-lg-none me-3"></i>
              <?php else: ?>
                <a class="btn btn-red-outline py-2 d-none d-lg-block me-5" style="width: 130px !important;" href="log_in_data.php">Log In</a>
                <a href="log_in_data.php" ><i class="bi bi-person-circle fs-3 text-light d-block d-lg-none me-3"></i></a>
              <?php endif; ?>
            </div>
          </div>
        </nav>
    ...
    <div class="container mt-5 mb-5">
        <div class="row justify-content-center">
            ...
            <div class="card shadow-lg rounded-4">
                ...
                <p class="mt-3 text-center">Already have an account? <a href="log_in_data.php">Log in</a></p>
                </div>
            </div>
            </div>
        </div>
